...
- **CA Wake Times** *(optional, recommended)*
  ...
  - **Why use it?** It lets you use Calendar Alarms for your wake-up alarm and move multiple sleep and wake alarms with one tap, without leaving your Home Screen. Instructions for setting this up appear later in the guide.
...
*This QR code was generated in the Calendar Alarm Editor with `qrCodeID` set to `"wakeup"`. See [QR Alarms](#qr-alarms) for more information.*
