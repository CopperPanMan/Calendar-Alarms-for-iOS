...
<br>
<em>This QR code was generated in the Calendar Alarm Editor using qrCodeID = "wakeup". Find more on configuring QR alarms in the QR Alarm section of Feature Reference, below.</em>
...
- Each QR alarm will have a matching QR code that turns it off. In the editor, enter the alarm's qrCodeID and select **Show QR Code** to preview, download, or print its matching code. Multiple alarms can share the same code. Scan that code to turn the alarm off.
