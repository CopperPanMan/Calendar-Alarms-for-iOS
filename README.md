...
> [!NOTE]
> *You can also give your AI-of-choice the link to [this github repo](https://github.com/CopperPanMan/Calendar-Alarms-for-iOS) and describe what alarms you want, and have it generate all of the JSON for you, which works suprisingly well (at least on GPT 5.5). You can always take it back into the Alarm Editor to edit.*
